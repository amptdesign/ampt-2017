...
$sql_layers_table = "CREATE TABLE " . $table_name_layers . " (
	...
	mlm_filter_details varchar(4000) DEFAULT NULL,
	PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;";
...
if (version_compare(get_option('leafletmapsmarker_version'),'3.10.4','=')) {
	...
	set_transient( 'leafletmapsmarker_install_update_cache_v3105', 'execute install and update-routine only once a day', 60*60*24 );
}
