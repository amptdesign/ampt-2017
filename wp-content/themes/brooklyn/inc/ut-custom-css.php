    ...
    function unitedthemes_custom_css() {
        ...
        $css  = '<style type="text/css">'. "\n";
            ...
            */
            ...
            if( ot_get_option('ut_navigation_shadow' , 'on' ) == 'off' ) {
            ...
            */
            if( ot_get_option('ut_site_border', 'hide' ) == 'show' ) { 
                ...
                /* html border */
                $css .= 'html { background: ' . $ut_site_border_color . '; border-left:30px solid ' . $ut_site_border_color . ' ; border-right:30px solid ' . $ut_site_border_color . '; }';
                
                /* top header background */
                $css .= '#ut-top-header { background: ' . $ut_site_border_color . '; }';
                
                /* placeholder color */
                if( ot_get_option('ut_navigation_state' , 'off') == 'on' ) {
            ...
            */
            ...
            |--------------------------------------------------------------------------
            */
            if( !is_front_page() && ( is_page() || is_singular('portfolio') || is_singular('product') ) ) {
            ...
            */
            ...
            if( is_front_page() ) {
                ...
                $ut_front_caption_slogan_color   = ot_get_option('ut_front_caption_slogan_color');
                    ...
                    /* add to CSS */
                    if( !empty( $ut_front_caption_slogan_color ) ) {                    
                        
                        $css.='.hero-description { color: ' . $ut_front_caption_slogan_color . ' }'. "\n";
            ...
            $ut_blog_caption_slogan_color   = ot_get_option('ut_blog_caption_slogan_color');
            ...
            if( !empty( $ut_blog_company_slogan_uppercase ) && is_home() && $ut_blog_company_slogan_uppercase == 'on' ) {
             ...
             /* add to CSS */
            if( !empty( $ut_blog_caption_slogan_color ) ) {                    
                $css.='.hero-description { color: ' . $ut_blog_caption_slogan_color . ' }'. "\n";
            }
            ...
            if( $ut_activate_csection == 'on' ) {
                ...
                if( $csection_background_type == 'image' ) {
                    ...
                    if( is_array( $ut_csection_background_image ) && !empty( $ut_csection_background_image['background-image'] ) ) {                    
                        ...
                        if( $csection_parallax == 'on' && !$detect->isMobile() ) {
