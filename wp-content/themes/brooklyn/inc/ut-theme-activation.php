    ...
    function ut_register_required_plugins() {
        ...
        $plugins = array(
		    ...
		    array(
				...
				'slug'     				=> 'ut-twitter',
				'source'   				=> THEME_DOCUMENT_ROOT . '/inc/lib/files/ut-twitter.zip', 
				'required' 				=> true, 
				'version' 				=> '3.1', 
			),
			...
			array(
				...
				'slug'     				=> 'ut-shortcodes',
				'source'   				=> THEME_DOCUMENT_ROOT . '/inc/lib/files/ut-shortcodes.zip', 
				'required' 				=> true, 
				'version' 				=> '3.4', 
			),
			...
			array(
				...
				'slug'     				=> 'ut-portfolio',
				'source'   				=> THEME_DOCUMENT_ROOT . '/inc/lib/files/ut-portfolio.zip', 
				'required' 				=> true, 
				'version' 				=> '3.8.2', 
			),
			...
			array(
				...
				'slug'     				=> 'ut-pricing',
				'source'   				=> THEME_DOCUMENT_ROOT . '/inc/lib/files/ut-pricing.zip', 
				'required' 				=> true, 
				'version' 				=> '2.3', 
			)
