<?php global $ut_load_ot_layout; if ( ! defined( 'OT_VERSION' ) && !$ut_load_ot_layout ) exit( 'No direct script access allowed' );
/**
...
if ( ! function_exists( 'ot_save_settings' ) ) {
  ...
  function ot_save_settings() {
    ...
    if ( isset( $_POST['option_tree_settings_nonce'] ) && wp_verify_nonce( $_POST['option_tree_settings_nonce'], 'option_tree_settings_form' ) ) {
      ...
      $settings['contextual_help'] = !empty($settings['contextual_help']) ? ot_stripslashes( $settings['contextual_help'] ) : '';
