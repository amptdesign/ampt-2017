  ...
  $ut_settings = array( 
    ...
    'settings'        => array(
      ...
      */
      ...
      array(
        ...
        'choices'     => array( 
          array(
            'value'       => 'show',
            'for'         => array('ut_site_border_color'),
            'label'       => 'Show'
          ),
          array(
            'value'       => 'hide',
      ...
      */
      ...
      array(
        'id'          => 'ut_navigation_padding_top',
        'label'       => 'Header / Navigation Padding Top',
        'desc'        => '<strong>(optional)</strong> - default 0px',
        'type'        => 'text',
        'section'     => 'ut_general_settings',
        'subsection'  => 'ut_navigation_settings',
      ),
      ...
      array(
        'id'          => 'ut_navigation_padding_bottom',
        'label'       => 'Header / Navigation Padding Bottom',
        'desc'        => '<strong>(optional)</strong> - default 0px',
        'type'        => 'text',
        'section'     => 'ut_general_settings',
        'subsection'  => 'ut_navigation_settings',
      ...
      array(
        ...
        'choices'     => array( 
          array(
            ...
            'for'         => array('ut_navigation_skin_dark_bgcolor'),
            'label'       => 'Dark'
          ),
          array(
            'value'       => 'ut-header-light',
            'for'         => array('ut_navigation_skin_light_bgcolor'),
            'label'       => 'Light'
          )
        ),
      ),
      ...
      array(
        'id'          => 'ut_navigation_skin_dark_bgcolor',
        'label'       => 'Header / Navigation Skin Background Color',
        'desc'        => '<strong>(optional)</strong> - set\'s an alternative background color for your navigation, since the base skin is dark, we recommend to use a dark color as well.',
        'type'        => 'colorpicker',
        'section'     => 'ut_general_settings',
        'subsection'  => 'ut_navigation_settings',
      ),
      ...
      array(
        'id'          => 'ut_navigation_skin_light_bgcolor',
        'label'       => 'Header / Navigation Skin Background Color',
        'desc'        => '<strong>(optional)</strong> - set\'s an alternative background color for your navigation, since the base skin is light, we recommend to use a bright color as well.',
        'type'        => 'colorpicker',
        'section'     => 'ut_general_settings',
        'subsection'  => 'ut_navigation_settings',
      ),
      ...
      array(
        ...
        'label'       => 'Header / Navigation Font Weight',
        'desc'        => '',
        'type'        => 'select',
        'section'     => 'ut_general_settings',
        'subsection'  => 'ut_navigation_settings',
      ...
      */
      ...
      array(
        ...
        'choices'     => array(           
          array(
            ...
            'for'         => array('ut_footer_skin_dark_bgcolor'),
            'label'       => 'Dark'
          ),
          array(
            'value'       => 'ut-footer-light',
            'for'         => array('ut_footer_skin_light_bgcolor'),
            'label'       => 'Light'
          )          
        ),
      ),      
      ...
      array(
        ...
        'desc'        => '<strong>(optional)</strong> - set\'s an alternative background color for your footer, since the base skin is dark, we recommend to use a dark color as well.',
        'type'        => 'colorpicker',
        'section'     => 'ut_general_settings',
        'subsection'  => 'ut_footer_settings',
      ),
      ...
      array(
        ...
        'label'       => 'Footer Skin Background Color',
        'desc'        => '<strong>(optional)</strong> - set\'s an alternative background color for your footer, since the base skin is light, we recommend to use a bright color as well.',
        'type'        => 'colorpicker',
        'section'     => 'ut_general_settings',
        'subsection'  => 'ut_footer_settings',
      ),
      ...
      array(
        ...
        'desc'        => '<strong>(optional)</strong> - set\'s an alternative background color for your subfooter.',
        'type'        => 'colorpicker',
        'section'     => 'ut_general_settings',
        'subsection'  => 'ut_footer_settings',
      ),
      ...
      */
      ...
      array(
        'id'          => 'ut_front_caption_slogan_color',
        'label'       => 'Hero Caption Slogan Color',
        'desc'        => '<strong>(optional)</strong> - set\'s an alternative for <strong>Hero Caption Slogan</strong>.',
        'type'        => 'colorpicker',
        'section'     => 'ut_front_page_settings',
        'subsection'  => 'ut_front_hero_settings'
      ),
      ...
      */
      ...
      array(
        ...
        'label'       => 'Select Overlay Pattern Style',
        'desc'        => '<strong>(optional)</strong>',
        'std'         => 'style_one',
        'type'        => 'select',
        'section'     => 'ut_front_page_settings',
